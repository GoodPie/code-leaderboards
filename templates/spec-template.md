...
## Public Interface Contracts (if applicable)

- Define inputs and outputs (schemas) for each public interface (API, background job, CLI/rake task)
- Document failure modes and side effects
- Provide a simple CLI or rake entrypoint for black-box testing where applicable
